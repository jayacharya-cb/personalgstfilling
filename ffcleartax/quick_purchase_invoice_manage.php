...
$main_page 	= "dashboard";
$page 		= "quick_invoice";
$page_title	= "Manage Purchase Invoices";
										...
										<div class="portlet-body">
											<div class="table-toolbar">
												<div class="row">
													<div class="col-md-6">
														<div class="btn-group">
															<a id="user_add_button" href="quick_purchase_invoice_crud.php?mode=a" class="btn green"> Add New
...
<script src="js/quick_purchase_invoice_datatable.js" type="text/javascript"></script>
