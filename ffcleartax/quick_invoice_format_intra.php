...
<tbody class="line_items">
	...
	<?php 
				...
				<tr>
					...
					<td  class="item-description"><?php echo $item['item_description'] ?></td>
					...
					<td class="text-right"> <?php echo $item['item_cgst_per'] ?> </td>
					<td class="text-right"><?php echo $item['item_cgst_amount'] ?> </td>
					<td class="text-right"> <?php echo $item['item_sgst_per'] ?> </td>
					<td class="text-right"><?php echo $item['item_sgst_amount'] ?> </td>
