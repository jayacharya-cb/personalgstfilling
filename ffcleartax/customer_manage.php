										...
										<div class="portlet-body">
											<div class="table-toolbar">
												<div class="row">
													<div class="col-md-6">
														<div class="btn-group">
															<a id="customer_add_button" href="#" data-callback=" TableCustomerDatatablesAjax.init" class="btn green customer-add-btn"> Add New
...
<script src="js/customer_datatable.js" type="text/javascript"></script>
