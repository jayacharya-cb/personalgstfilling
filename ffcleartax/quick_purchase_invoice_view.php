                        ...
                        <div class="page-content-wrapper">
                            ...
                            <div class="page-head">
                                <div class="container-fluid">
									...
									<a class="btn btn-sm blue hidden-print margin-bottom-5 mt3 pull-right mr1" href="quick_purchase_invoice_crud.php?mode=edit&iid=<?php echo $id; ?>"> Edit
                                        ...
                                        <div class="invoice" >
											...
											<div class="row">
                                                <div class="col-xs-12 text-center">
                                                    <div class="h2 bold mt0">Purchase Invoice</div>
                                                </div>
												<div class="col-xs-12">
												<div class="row">
                                                    <div class="col-xs-12">
														<p class="mt0 mb0"><b>Supplier:&nbsp;&nbsp;<?php echo strtoupper($invoice['customer_name'])."(".$invoice['customer_gstin'].")"; ?></b>&nbsp;
														
														
														Address:&nbsp; <?php echo $invoice['customer_billing_address']; ?>&nbsp;<?php echo $invoice['customer_billing_city']; ?><?php echo (($invoice['customer_billing_city']!="")?"-":"").$invoice['customer_billing_pincode']; ?><?php echo ",".$invoice['customer_billing_state']; ?> </p>
													</div>
                                                </div>
                                                </div>
												...
												<div class="row">
                                                    <div class="col-xs-12">
														<p class="mt0 mb0"><b>Recipient:&nbsp;<?php echo strtoupper(CLIENT_NAME); ?></b> &nbsp;Address:&nbsp;<?php echo strtoupper(CLIENT_ADDRESS)?> GSTIN No.<?php echo GST_NO?></p>
													</div>
                                                </div>
												<hr class="mt1 mb1 bg-black" style="background-color:#000;height:1px"/>
												<div class="row">
                                                    <div class="col-xs-12">
														<p class="mt0 mb0">Purchase Invoice No-Date:<b>&nbsp;&nbsp;<?php echo strtoupper($invoice['invoice_serial_no']); ?>-<?php echo date("d-M-y",strtotime($invoice['invoice_date'])); ?></b></p>
													</div>
                                                </div>
                                                </div>
                                            </div>
