												 ...
												 while($r=mysql_fetch_assoc($ctable_r))
												 {
													 ...
													 ?>
													  <tr class="">
														...
														<td>
														<a class="edit-item-btn btn btn-primary" data-cid="<?php echo $r['aid'] ?>" data-mode="edit" data-callback=" TableQuickInvoiceItemDatatablesAjax.init" ><i class="fa fa-pencil"></i></a>
														<a class="delete-item-btn btn btn-danger" data-cid="<?php echo $r['aid'] ?>"><i class="fa fa-trash"></i></a>
														</td>
														</tr>
													<?php
