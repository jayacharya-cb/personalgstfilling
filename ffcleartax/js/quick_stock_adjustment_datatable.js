var TableQuickInvoiceItemDatatablesAjax = function () {
	var table_container=$("#quick_stock_adjustment_container");
	var ajax_url="quick_stock_adjustment_get_ajax.php";
    ...
    var handleTable = function () {
		var table=$("#quick_stock_adjustment_table_id");
		var table_container=$("#quick_stock_adjustment_container");
		var pagination_buttons=$(table_container).find('.quick_stock_adjustment_pagination').children("li.paginate_button").find("a");
		...
		var editBtn=$(table_container).find('a.quick_stock_adjustment_table_id_edit');
		var deleteBtn=$(table_container).find('a.quick_stock_adjustment_table_id_delete');
		var activeBtn=$(table_container).find('a.quick_stock_adjustment_table_id_active');
		var deactiveBtn=$(table_container).find('a.quick_stock_adjustment_table_id_deactive');
		...
		$(searchBtn).on('click',function(){
			query=$("#quick_stock_adjustment_search_input").val();
			getDataFromAJAX();
		});
