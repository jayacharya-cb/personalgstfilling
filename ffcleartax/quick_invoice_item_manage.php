										...
										<div class="portlet-body">
											<div class="table-toolbar">
												<div class="row">
													<div class="col-md-6">
														<div class="btn-group">
															<a id="customer_add_button" href="#" data-callback=" TableQuickInvoiceItemDatatablesAjax.init" class="btn green item-add-btn"> Add New
...
<script src="js/quick_invoice_item_datatable.js" type="text/javascript"></script>
