                                                ...
                                                <div class="portlet-body">
                                                    <div class="tab-content">
														...
														<!-- // onSubmit="return check_form();" -->
                                                           <form role="form"  data-parsley-validate=""  action="" method="post" id="user-profile-form">
                                                                <div class="form-group">
                                                                    <label class="control-label">Name</label>
                                                                    <input name="name" id="name" type="text" placeholder="Your Name"  data-validation="length" data-validation-length="min20" data-validation-error-msg="Enter atleast 20 Characters" value="<?php echo $loggedInUser['name']; ?>" class="form-control" /> 
																...
																<div class="form-group">
                                                                    ...
                                                                    <input name="email" data-parsley-type-message="Enter Valid Email" id="email" type="email" data-validate-type="email" placeholder="Your Name" value="<?php echo $loggedInUser['email']; ?>" class="form-control" /> 
																	<p class="help-block"></p>
																	</div>		
