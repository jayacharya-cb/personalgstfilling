...
if(isset($_REQUEST['query']) && $_REQUEST['query']!=""){
	...
	$ctable_where .= " (
							aid LIKE '%".$search_query."%'  OR description LIKE '%".$search_query."%'  OR gst_code LIKE '%".$search_query."%' ) AND ";
}
...
<form action="" name="frm" id="frm" method="post">
	...
	<table class="table table-striped table-hover table-bordered quick_stock_adjustment_table_class" id="quick_invoice_table_id">
                                            <thead>
                                                <tr>
                                                    <th>ID</th>
													<th>Description</th>
