...
$page_id="507";
$page_slug="quick_purchase_invoice";
include("connect.php");
$ctable 	= "quick_purchase_invoice_info";
$ctable_where = "";
$search_query = "";
												 ...
												 while($r=mysql_fetch_assoc($ctable_r))
												 {
													 ...
													 ?>
													  <tr class="">
														...
														<td><a href="quick_purchase_invoice_view.php?m=e&iid=<?php echo $r['id']; ?>"><?php echo $r['invoice_serial_no']; ?></a></td>
