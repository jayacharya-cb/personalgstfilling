...
class Customer extends Functions
{
	...
	function getCustomerDetail($user_id=0,$required_columns=array(),$isChatRequired=false)
	{/*
	...
	function getCustomers($user_id=0,$required_columns=array())
	{
		$required_columns=$this->getRequiredColumns($required_columns);
		if($user_id!=0)
		{
			
			$result_admins=$this->rp_getData($this->ctable,$required_columns,"1=1");
			if($result_admins)
			{
